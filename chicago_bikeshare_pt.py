...
def count_gender(data_list):
    """
    Função que responsavel pela contagem dos generos em cada lista
      Argumentos:
          data_list: A lista de todos os gêneros (list).
      Retorno:
          oferece a lista com as quantidades de dos generos masculino e feminino, no formato [qntd_male, qntd_female].
    """
    male = 0
    female = 0
...
def most_popular_gender(data_list):
    """
    Função irá retornar o gênero mais popular de uma lista de todos os generos disponiveis.
      Argumentos:
          data_list: lista de gêneros (list).
      Retorna:
          Uma string com o gênero mais popular:
          "Male" = Masculino,"Female" = Feminino ou "Equal" = Igual.
    """
    answer = ""
...
answer = "Existem na massa de dados {} amostras sem nenhuma informação a respeito do gênero.".format(vazio)
...
# Alterando os dados para float
trip_duration_list = list(map(float,trip_duration_list))

# Encontrar max e min e somar
...
# Arredondando os valores de saida
